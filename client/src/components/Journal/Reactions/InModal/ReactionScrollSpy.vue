<template>
    <scroll-spy :isMobile='props.isMobile'>
        <template #scrollspy_articles>
            ...
            <scroll-spy-item :item_id='"most_popular"' :visible=false>
            ...
            <scroll-spy-item :item_id='"all"' :visible=true>
                <template #scrollspy_section__header>Dota 2</template>
                <template #scrollspy_section__body>
        ...
        <template #scrollspy_aside__links>
            ...
            </scroll-spy-aside-item>

            <scroll-spy-aside-item :item_id='"favorites"'>
                <template #scrollspy_aside__body>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <scroll-spy-aside-item :item_id='"most_popular"'>
                <template #scrollspy_aside__body>
