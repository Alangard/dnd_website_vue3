<template>
    <modal @close_modal='this.$emit("close_modal")'>
        ...
        <template #modal_body>
            <ul>
                <li @click='this.$emit("close_modal")'> 
                ...
                <li class='hide_content' @click='this.$emit("close_modal")'>
                    ...
                    Hide author's content
                </li>
                <div class="personal_func" v-if="user=='self'">
                    <li @click='this.$emit("StartEdit"), this.$emit("close_modal")'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#290000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li @click='this.$emit("DeleteComment"), this.$emit("close_modal")'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#290000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
