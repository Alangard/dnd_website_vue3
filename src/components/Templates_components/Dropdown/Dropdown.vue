            ...
            <div class="dropdown_body" v-if="menuIsOpen == true">
                    <div v-if="this.isBlock == true">
                        <div v-if="this.current_user_info.username != this.user_info.username">
                            <ul>
                                ...
                                <li class='hide_content' @click="this.menuIsOpen = false">
                    ...
                    <div v-else>
                        <div v-if="this.comment_text != '*Comment was deleted*'">
                            ...
                            <div v-else>
                                <li @click="this.$emit('StartEdit'), this.menuIsOpen = false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#290000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <li class='delete_comment' @click="this.$emit('showDeleteAlert'), this.menuIsOpen = false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#290000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
